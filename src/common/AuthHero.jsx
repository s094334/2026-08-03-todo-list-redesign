...
function AuthHero() {
  return (
    <div className="relative flex flex-col border-b border-line px-6 py-10 lg:border-r lg:border-b-0 lg:px-12 lg:py-11">
      ...
      <figure className="relative mt-8 grid flex-1 place-items-center border border-line p-7 lg:min-h-[260px]">
        ...
        <div className="flex flex-col items-center gap-4 text-accent-600">
          <ClipboardIcon />
          <figcaption className="text-center text-sm leading-[1.8] text-accent-700 text-pretty lg:whitespace-nowrap">
